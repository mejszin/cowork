function renderTextCard(props, is_to = false) {
    ...
    var is_system = ('system' in props) ? props.system : false;
    card_wrap.classList.add('card-wrap', is_system ? 'system' : (is_to ? 'to' : 'from'))
    card_list.appendChild(card_wrap);
    var card_div = document.createElement('div');
    card_div.classList.add('card', 'my-2', 'mx-4');
    card_wrap.appendChild(card_div);
    ...
    content_div.classList.add('content', 'is-small');
...
function renderImageCard(props) {
    var card_list = document.getElementById('card-list');
    var card_wrap = document.createElement('div');
    card_wrap.classList.add('card-wrap', is_to ? 'to' : 'from')
    card_list.appendChild(card_wrap);
    var card_div = document.createElement('div');
    card_div.classList.add('card', 'my-2', 'mx-4');
    card_wrap.appendChild(card_div);
